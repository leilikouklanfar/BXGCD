...
// size opf x == size of y
void mp_subtract(unsigned int *x, unsigned int *y, int size)
{
    unsigned int c = 0;
...
long bbxgcd(int x, int y)
{
    char *xb = int2bin(63486);
    // printf("\nx: %d\n", x);
    printf("\nxbstr: %s\n", xb);
    long start_time, stop_time;
    int g, u, s1, t1, s2, t2, v;
...
int main()
{
    // unsigned int x_3[8] = {0, 0, 0, 0, 0, 0, 0, 0};
    //  unsigned int y_2[8] = {0, 0, 0, 0, 0, 1, 0, 1};
    unsigned int x_3[4] = {0, 0, 0, 1};
    unsigned int y_2[4] = {1, 1, 1, 1};
    mp_subtract(x_3, y_2, 4);
    printf("3-2:");
    for (int i = 0; i < 4; i++)
    {
        printf("%d", x_3[i]);
    ...
    printf("\n(-3)-2:");
    unsigned int x_n3[6] = {1, 1, 1, 1, 0, 1};
    mp_subtract(x_n3, y_2, 6);
    for (int i = 0; i < 6; i++)
    {
        printf("%d", x_n3[i]);
    }
    ...
    /*
     ...
     for (int i = 0; i < sampleSize; i++)
     {
         ...
         bxgcd_run_time += bbxgcd(rNum1, rNum2);
         //  r_x = r_y;
     }
